...
module Adept::Models
    ...
    class CreateTheBasics < V 1.0
      def self.up
        create_table :adept_posts, :force => true do |t|
          t.column :id,       :integer, :null => false
          t.column :user_id,  :integer, :null => false
          t.column :title,    :string,  :limit => 255
          t.column :body,     :text
        end
        create_table :adept_users, :force => true do |t|
          t.column :id,       :integer, :null => false
          t.column :username, :string
          t.column :password, :string
        end
        create_table :adept_comments, :force => true do |t|
          t.column :id,       :integer, :null => false
      ...
      def self.down
        drop_table :adept_posts
        drop_table :adept_users
        drop_table :adept_comments
      end
    end
end

module Adept::Controllers
    class Index < R '/'
        def get
            @posts = Post.find :all
            render :index
...
module Adept::Views
    ...
    def layout
      html do
        ...
        body do
          h1.header { a 'adept', :href => R(Index) }
          div.content do
            self << yield
          end
        end
...
def Adept.create
    ...
    Adept::Models.create_schema :assume => (Adept::Models::Post.table_exists? ? 1.0 : 0.0)
end
